...
echo -e "${Cyan}+-------------------------------------------------------------------+${NC}"
echo -e "${Cyan}|${NC}                      ${BGreen}[${NC}${BRed}          FUCK!{NC}${BGreen}]${NC}                    ${Cyan}|${NC}"
echo -e "${Cyan}|${NC}                                                                   ${Cyan}|${NC}"
echo -e "${Cyan}|${NC}                                            | ${NC}${Yellow}Coder:${NC}${BGreen} Avindeso${NC}${NC} | ${NC}${Cyan}|${NC}"
echo -e "${Cyan}|${NC}                                            | ${Yellow}Version:${NC} ${BGreen}1.0${NC}       | ${Cyan}|${NC}"
echo -e "${Cyan}+-${NC}${Green}[ Enter Your Choice ]${Cyan}---------------------------------------------${Cyan}+${NC}"
echo -e "${Yellow}1. ${NC}SMS"
echo -e "${Yellow}2. ${NC}Call\n"
