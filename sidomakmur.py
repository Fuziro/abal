...
def main(phone_num, delay, limit, country_code):
    ...
    (example: 6285373045750 with 62 prefix as the country code)
    """
    i = 0
...
if __name__ == '__main__':
    click.secho(f'{sys.argv[0]} \u2014 Grab Activation Code (GAC) spammer',
                fg='black',
                bg='green')
    click.echo(' author\tAvindeso <me@lcat.dev>')
    click.echo(' url\thttps://github.com/Fuziro\n')
    main()
